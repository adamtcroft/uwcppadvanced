...
BitmapGraphics::WindowsBitmapHeader::WindowsBitmapHeader(std::istream& sourceStream)
{
	read(sourceStream);
}

void BitmapGraphics::WindowsBitmapHeader::read(std::istream& sourceStream)
{
	readFileHeader(sourceStream);
	readInfoHeader(sourceStream);
}

void BitmapGraphics::WindowsBitmapHeader::readFileHeader(std::istream& sourceStream)
{
...
void BitmapGraphics::WindowsBitmapHeader::readInfoHeader(std::istream& sourceStream)
{
...
void BitmapGraphics::WindowsBitmapHeader::write(std::ostream& destinationStream) const
{
	writeFileHeader(destinationStream);
	writeInfoHeader(destinationStream);
}

void BitmapGraphics::WindowsBitmapHeader::writeFileHeader(std::ostream& destinationStream) const
{
...
void BitmapGraphics::WindowsBitmapHeader::writeInfoHeader(std::ostream& destinationStream) const
{
